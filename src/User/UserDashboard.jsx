...
//     <>
//       {/* Navbar */}
//       <nav className="navbar navbar-expand-lg navbar-light fixed-top bg-white shadow-sm px-3">
//         <div className="container-fluid d-flex justify-content-between align-items-center">
//           <div className="d-flex align-items-center">
//             <img
//               src="https://s3.ap-south-1.amazonaws.com/gotouniv/uploads/577/logo/logo_170X115.png"
...
const UserDashboard = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="navbar navbar-expand-lg navbar-light fixed-top bg-white shadow-sm px-3" style={{ zIndex: 1050 }}>
        <div className="container-fluid d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center">
            <img
              src="https://s3.ap-south-1.amazonaws.com/gotouniv/uploads/577/logo/logo_170X115.png"
      ...
      <div className="d-flex" style={{ height: "calc(100vh - 72px)" }}>
        {/* Sidebar */}
        <div className="bg-dark text-white p-3 position-fixed" style={{ width: "250px", top: "72px", height: "calc(100vh - 72px)" }}>
          <h5 className="text-center mb-4">Menu</h5>
          <ul className="nav flex-column">
            <li className="nav-item mb-2">
              <Link to="upload" className="nav-link text-white">
        ...
        {/* Main Content */}
        <div className="flex-grow-1 p-4 bg-light" style={{ marginLeft: "250px", marginTop: "72px" }}>
          <Outlet />
        </div>
      </div>
    </>
